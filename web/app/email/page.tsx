                                    ...
                                    return mails.map(m => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-[11px] font-medium text-slate-400 dark:text-slate-500 truncate mt-1">{m.bodyText}</p>
                                            </div>
                                            <div className="flex flex-col gap-2 shrink-0 self-center">
                                                <button 
                                                    onClick={(e) => { e.stopPropagation(); handleEmailAction(m.id, 'archive'); }} 
                                                    className="p-1.5 text-slate-300 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-600/10 rounded-lg transition-all"
                                                    title="Archive"
                                                >
                                                ...
                                                <button 
                                                    ...
                                                    className="p-1.5 text-slate-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-600/10 rounded-lg transition-all"
                                                    title="Delete"
                                                >
