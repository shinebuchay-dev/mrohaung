    ...
    return sendEmail({
        ...
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #f0f0f0; border-radius: 20px; background: white; text-align: center;">
                ...
                <p style="color: #666; line-height: 1.6;">Welcome ${displayName}! Please click the button below to verify your account. <b>Unverified accounts cannot post or interact.</b></p>
